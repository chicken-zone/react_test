...
describe("Test the Login Component", () => {
  ...
  test("email input field should accept email", () => {
    ...
    userEvent.type(email, "keke");
    expect(email.value).not.toMatch("keke@gmail.com");
  });
...
//     userEvent.type(email, "keke@gmail.com");
//     userEvent.type(password, "12345");

//     userEvent.click(submitButton);

//     const userInfo = screen.getByText("keke@gmail.com");
